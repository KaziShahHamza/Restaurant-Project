...
const About = () => {
  ...
  return (
    <section className="container mx-auto mt-8 mb-8" id="about">
      <h2 className="my-8 text-center text-3xl tracking-tighter lg:text-4xl">About Us</h2>
      <div className="flex flex-wrap">
        <div className="w-full p-4 lg:w-1/2">
          <img src="https://4.imimg.com/data4/LL/UX/MY-2792041/kfc-projects.jpg" className="rounded-3xl lg:-rotate-3" />
        </div>
